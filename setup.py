...
options = dict(py2exe = dict(
    ...
    excludes = ['difflib', 'doctest', 'hashlib', 'locale', 'logging', 'optparse', 'pickle', 'calendar', 'serialposix', 'serialjava', 'serialcli']
))
...
setup(version = '1.0',
      description = 'Executes commands received from a serial port via shell',
